...
const embedDatabase: Record<string, Record<string, string[]>> = {
  "大大吃": {
    "中式/台式": ["必比登台式合菜", "饗食天堂 旭集", "熱炒", "別偷懶給我自己煮^_^"],
    "日式": ["和牛燒肉", "無菜單日料", "板前料理", "那家不敢踏進去的高級居酒屋", "別偷懶給我自己煮^_^"],
    "美式/義式": ["餐酒館", "美式煙燻烤肉", "Fine Dining", "別偷懶給我自己煮^_^"]
  },
  "小小吃": {
    "中式/台式": ["巷口牛肉麵", "巷口滷肉飯", "那家好吃的鹹酥雞", "那家好吃的串燒", "別偷懶給我自己煮^_^"],
    "日式": ["章魚燒吧？", "小小吃還分什麼國籍料理", "C/P值最高那家居酒屋生啤先上兩杯", "別偷懶給我自己煮^_^"],
    "美式/義式": ["肯德基", "漢堡王", "拿坡里", "達美樂", "別偷懶給我自己煮^_^"]
  }
};
